...
public enum Blocks {
    ...
    private Blocks(String name, int id, int topTextureId, int bottomTextureId, int leftTextureId, int rightTextureId,
            int frontTextureId, int backTextureId) {
        this.name = name;
        this.id = id;
    ...
    public Block createBlock(int x, int y, int z, Texture fullTexture, TextureRegion[][] tiles) {
        ...
        meshBuilder.rect(new Vector3(2, -2, -2), new Vector3(-2, -2, -2), new Vector3(-2, 2, -2), new Vector3(2, 2, -2),
                new Vector3(0, 0, -1));
